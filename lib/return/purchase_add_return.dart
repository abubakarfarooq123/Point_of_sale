...
class Add_return_purchase extends StatefulWidget {
  @override
  State<Add_return_purchase> createState() => _Add_return_purchaseState();
}

class _Add_return_purchaseState extends State<Add_return_purchase> {
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Text(
                      "To return, please type the order reference and press enter. The form will be filled with the purchase information.",
                      style:
