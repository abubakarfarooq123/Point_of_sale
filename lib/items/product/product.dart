          ...
          child: Column(
            ...
            children: [
              ...
              DataTable(
                  ...
                  columns: [
                    DataColumn(
                      label:  Text('Products',style: GoogleFonts.roboto(
                    ...
                    DataColumn(
                      label: Text('Brand',style: GoogleFonts.roboto(
                        fontWeight: FontWeight.bold,
                        color: Colors.white,
                      ),
                      ),
                    ...
                    DataColumn(
                      label: Text('SKU',style: GoogleFonts.roboto(
                        fontWeight: FontWeight.bold,
                        color: Colors.white,
                      ),
                      ),
                    ...
                    DataColumn(
                      label: Text('Unit',style: GoogleFonts.roboto(
                        fontWeight: FontWeight.bold,
                        color: Colors.white,
                      ),
                      ),
                    ...
                    DataColumn(
                      label: Text('Purchase Price',style: GoogleFonts.roboto(
                        fontWeight: FontWeight.bold,
                        color: Colors.white,
                      ),
                      ),
                    ...
                    DataColumn(
                      label: Text('Retail Price',style: GoogleFonts.roboto(
                        fontWeight: FontWeight.bold,
                        color: Colors.white,
                      ),
                      ),
                    ...
                    DataColumn(
                      label: Text('Wholesale Price',style: GoogleFonts.roboto(
                        fontWeight: FontWeight.bold,
                        color: Colors.white,
                      ),
                      ),
                    ...
                    DataColumn(
                      label: Text('Stock Availabiltiy',style: GoogleFonts.roboto(
                        fontWeight: FontWeight.bold,
                        color: Colors.white,
                      ),
                      ),
                    ...
                    DataColumn(
                      label: Text('Description',style: GoogleFonts.roboto(
                        fontWeight: FontWeight.bold,
                        color: Colors.white,
                      ),
                      ),
                  ...
                  rows: [
                    ...
                    DataRow(cells: [
                      ...
                      DataCell(Text('Gull Ahmad'),
                      ),
                      DataCell(Text('Washing Wear'),
                      ),
                      DataCell(Padding(
                      ...
                      DataCell(Text('0 Stock'),
                      ),
                      DataCell(Padding(
                        padding: const EdgeInsets.only(left: 30),
                        child: Text('Khata Khul gya'),
                      ),
                      ),
                      DataCell( Row(
                        children: [
